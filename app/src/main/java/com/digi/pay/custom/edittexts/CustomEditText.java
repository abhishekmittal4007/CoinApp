...
public class CustomEditText extends FrameLayout {
    ...
    public CustomEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        defaultLabelSize = getResources().getDimension(R.dimen._15sdp);
        mTextSize = styleable.getDimensionPixelSize(R.styleable.CustomEditText_edt_text_size,
                DimensionsUtils.getDimensionPixelSize(context, R.dimen._13sdp));
    ...
    private void setTypeface() {
        Typeface font = get(getContext(), "fonts/montserrat_medium.ttf");
